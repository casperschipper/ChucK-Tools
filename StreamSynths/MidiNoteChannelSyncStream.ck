<<<"Midi Note Channel Sync Stream">>>;
public class MidiNoteChannelSyncStream extends StreamSynth {
    MidiOut mout;
    MidiMsg msg;
    ...
    fun MidiNoteChannelSyncStream port(int arg) {
        if (mout.open(arg)) {
    ...
    fun MidiNoteChannelSyncStream init(Stream pitchArg,Stream veloArg,Stream duraArg,Stream delta,Stream channel) {
        pitchArg @=> st_pitch;
        veloArg @=> st_velo;
        duraArg @=> st_dura;
        channel @=> st_channel;
